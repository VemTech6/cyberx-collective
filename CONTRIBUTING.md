...
> [!IMPORTANT]
> Don't add real names, real résumés, or personal contact information here — this repo is structured to go public, so treat everything as if it's already indexed and public.
